...
def report(label, fractions, ref=None):
    mean = np.mean(fractions)
...
if __name__ == "__main__":
    ...
    report("Poisson / Exp", bp, ref=erlang_blocking)
    ...
    report("Constant 8.0", bp, ref=erlang_blocking)
    ...
    report("Chi2(df=8)", bp, ref=erlang_blocking)

...
class AppLogger:
    ...
    def info(self, message: str, **kwargs):
        self.logger.info(f"{message}{self._format_extras(**kwargs)}")

    def warning(self, message: str, **kwargs):
        self.logger.warning(f"{message}{self._format_extras(**kwargs)}")

    def error(self, message: str, **kwargs):
        self.logger.error(f"{message}{self._format_extras(**kwargs)}")

    def success(self, message: str, **kwargs):
        self.logger.log(SUCCESS_LEVEL, f"{message}{self._format_extras(**kwargs)}")

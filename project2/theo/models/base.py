...
# NOTE: This is the group's shared continuous-time-Markov-chain (Gillespie) engine,
# kept as a local copy so the `theo` package is self-contained. The SIRD model and
# the Part I(c) analysis built on top of it are the individual contribution.
